        ...
        <div class="auth-form-section">
            <div class="auth-form-container">
                <div class="auth-header">
                    ...
                    <p class="auth-subtitle">Créez votre compte RoukLegal</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        <label for="nom" class="form-label"><i class="fas fa-user"></i> Nom complet</label>
                        <input type="text" id="nom" name="nom" class="form-control" value="{{ old('nom') }}" required placeholder="Jean Dupont">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="mot_de_passe_confirmation" name="mot_de_passe_confirmation" class="form-control" required placeholder="••••••••">
                    </div>
                    <button type="submit" class="btn btn-register"><i class="fas fa-user-plus"></i> S'inscrire</button>
                </form>
